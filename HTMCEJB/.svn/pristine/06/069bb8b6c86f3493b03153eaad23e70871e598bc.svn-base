...
/**
 * The persistent class for the consolidado_ingreso database table.
 * 
 */
@Entity
@Table(name="consolidado_ingreso")
@NamedQuery(name="ConsolidadoIngreso.findAll", query="SELECT c FROM ConsolidadoIngreso c")
public class ConsolidadoIngreso implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ConsolidadoIngresoPK id;
	...
	public ConsolidadoIngreso() {
	}

	public ConsolidadoIngresoPK getId() {
		return this.id;
	}

	public void setId(ConsolidadoIngresoPK id) {
		this.id = id;
	}
